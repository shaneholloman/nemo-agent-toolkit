...
def set_framework_profiler_handler(
    ...
    Args:
        ...
        frameworks (list[LLMFrameworkEnum] | None): A list of LLM frameworks
            used in the workflow functions.
    Returns:
        Callable[[Callable[..., AsyncContextManager[Any]]], Callable[..., AsyncContextManager[Any]]]:
...
def chain_wrapped_build_fn(
    ...
    Args:
        ...
        function_frameworks (list[LLMFrameworkEnum]): A list of LLM frameworks used
            in the workflow functions.
    ...
    @asynccontextmanager
    async def base_fn(*args, **kwargs) -> Callable[Any]:
