...
class ADKProfilerHandler(BaseProfilerCallback):
    ...
    def instrument(self) -> None:
        ...
        try:
            ...
            logger.error("ADK import failed; skipping instrumentation: %s", e)
            return
    ...
    def uninstrument(self) -> None:
        ...
        try:
            ...
            logger.error("Failed to uninstrument ADKProfilerHandler: %s", e)
    ...
    def _tool_use_monkey_patch(self) -> Callable[..., Any]:
        ...
        async def wrapped_tool_use(base_tool_instance, *args, **kwargs) -> Any:
            ...
            try:
                ...
                logger.error("Error getting tool name: %s", e, exc_info=True)
                tool_name = ""
    ...
    def _llm_call_monkey_patch(self) -> Callable[..., Any]:
        ...
        async def wrapped_llm_call(*args, **kwargs) -> Any:
            ...
            try:
                ...
                logger.error("Error getting model input: %s", e, exc_info=True)
            ...
            try:
                ...
                logger.error("Error getting model output: %s", e, exc_info=True)
            ...
            try:
                ...
                logger.error("Error preparing chat_responses: %s", e)
            ...
            try:
                ...
                logger.error("Error preparing token usage: %s", e)
